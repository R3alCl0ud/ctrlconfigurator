...
LidColor _BASE_Colors[L_BASE] = {
    {0, 87, hex_to_color(58879)}
};

LidColor _MEDIA_Colors[L_MEDIA] = {
    {0, 1, hex_to_color(58879)},
    {1, 1, hex_to_color(65280)},
    {5, 1, hex_to_color(13369589)},
    {7, 6, hex_to_color(13369589)},
    {43, 1, hex_to_color(62736)},
    {55, 1, hex_to_color(13369589)},
    {68, 2, hex_to_color(13369589)},
    {77, 1, hex_to_color(13369589)}
};

LidColor _TYPELIGHT_Colors[L_TYPELIGHT] = {
    {34, 5, hex_to_color(62736)},
    {51, 5, hex_to_color(62736)},
    {64, 2, hex_to_color(62736)},
    {75, 1, hex_to_color(62736)},
    {84, 3, hex_to_color(62736)}
};
